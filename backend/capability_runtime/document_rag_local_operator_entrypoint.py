    ...
    *,
    ...
    if readiness.decision == "blocked":
        return _operator_result(
            ...
            summary=_trial_summary(document_path, source_id, readiness.decision, "not_run"),
    ...
    return _operator_result(
        ...
        summary={
            **_trial_summary(document_path, source_id, readiness.decision, upload.decision),
...
def _trial_summary(document_path: Path, source_id: str, readiness_decision: str, upload_decision: str) -> dict[str, Any]:
    return {
