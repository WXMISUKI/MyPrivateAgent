...
class RuntimeSurfaceService:
    ...
    def _build_runtime_core_contract(self, *, runtime_scope: Dict[str, Any] | None = None) -> Dict[str, Any]:
        contract = {
            ...
            **self._build_child_merge_state_contract(),
        }
        scope = dict(runtime_scope or {})
        if scope:
            ...
            contract["child_display_id"] = str(scope.get("child_display_id") or scope.get("child_run_id") or "").strip()
            ...
            contract.update(self._build_child_merge_state_contract(scope))
        return contract
