...
ENABLE_OCR_CAPABILITY_PROVIDER = _env_flag("ENABLE_OCR_CAPABILITY_PROVIDER", "false")
OCR_CAPABILITY_PROVIDER_BASE_URL = os.getenv("OCR_CAPABILITY_PROVIDER_BASE_URL", "http://127.0.0.1:8080").strip()
OCR_CAPABILITY_PROVIDER_TIMEOUT_SECONDS = float(os.getenv("OCR_CAPABILITY_PROVIDER_TIMEOUT_SECONDS", "30"))
ENABLE_LAYOUT_CAPABILITY_PROVIDER = _env_flag("ENABLE_LAYOUT_CAPABILITY_PROVIDER", "false")
LAYOUT_CAPABILITY_PROVIDER_BASE_URL = os.getenv("LAYOUT_CAPABILITY_PROVIDER_BASE_URL", "http://127.0.0.1:8080").strip()
LAYOUT_CAPABILITY_PROVIDER_TIMEOUT_SECONDS = float(os.getenv("LAYOUT_CAPABILITY_PROVIDER_TIMEOUT_SECONDS", "60"))
LAYOUT_CAPABILITY_PROVIDER_INVOKE_PATH = os.getenv("LAYOUT_CAPABILITY_PROVIDER_INVOKE_PATH", "/layout-parsing").strip()
ENABLE_VLM_CAPABILITY_PROVIDER = _env_flag("ENABLE_VLM_CAPABILITY_PROVIDER", "false")
VLM_CAPABILITY_PROVIDER_BASE_URL = os.getenv("VLM_CAPABILITY_PROVIDER_BASE_URL", "http://127.0.0.1:8080").strip()
VLM_CAPABILITY_PROVIDER_TIMEOUT_SECONDS = float(os.getenv("VLM_CAPABILITY_PROVIDER_TIMEOUT_SECONDS", "90"))
VLM_CAPABILITY_PROVIDER_INVOKE_PATH = os.getenv("VLM_CAPABILITY_PROVIDER_INVOKE_PATH", "/vlm").strip()
VLM_CAPABILITY_PROVIDER_ASYNC_SUBMIT_PATH = os.getenv("VLM_CAPABILITY_PROVIDER_ASYNC_SUBMIT_PATH", "/api/vlm/jobs").strip()
VLM_CAPABILITY_PROVIDER_ASYNC_STATUS_PATH_TEMPLATE = os.getenv(
    "VLM_CAPABILITY_PROVIDER_ASYNC_STATUS_PATH_TEMPLATE",
    "/api/vlm/jobs/{job_id}",
).strip()
CAPABILITY_PROVIDER_HEARTBEAT_FAILURE_THRESHOLD = int(
    os.getenv("CAPABILITY_PROVIDER_HEARTBEAT_FAILURE_THRESHOLD", "3")
)
CAPABILITY_PROVIDER_HEARTBEAT_COOLDOWN_SECONDS = float(
    os.getenv("CAPABILITY_PROVIDER_HEARTBEAT_COOLDOWN_SECONDS", "30")
)
