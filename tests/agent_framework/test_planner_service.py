...
class PlannerServiceTests(unittest.TestCase):
    def test_serialize_plan_includes_required_capabilities(self):
        ...
        self.assertEqual(serialized["items"][0]["scheduler_snapshot"]["children"][0]["child_display_id"], "backend-child-p1-i11-c1")
        self.assertEqual(serialized["items"][0]["child_executions"][0]["agent_role"], "backend")
        self.assertEqual(serialized["items"][0]["child_executions"][0]["child_display_id"], "backend-child-p1-i11-c1")
