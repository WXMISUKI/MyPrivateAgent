...
class RuntimeSurfaceServiceTests(unittest.TestCase):
    ...
    def test_runtime_profile_surfaces_latest_main_chat_query_control_trace(
        ...
        self.assertEqual(profile["main_chat_trace_overview"]["recent_queries"][0]["read_model_layer"], "recent_summary")
        self.assertEqual(profile["main_chat_trace_overview"]["recent_queries"][0]["source_channel"], "main_chat")
        self.assertEqual(profile["main_chat_trace_overview"]["recent_queries"][0]["identity_kind"], "query_id")
        ...
        self.assertEqual(history["items"][0]["read_model_layer"], "recent_summary")
        self.assertEqual(history["items"][0]["source_channel"], "main_chat")
        self.assertEqual(history["items"][0]["identity_kind"], "query_id")
