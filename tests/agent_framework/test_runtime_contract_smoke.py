                ...
                200,
                {
                    ...
                    "child_executor_promotion_gate": {
                        ...
                        "child_executor_execution_prerequisites": {
                            ...
                            "requirements": [
                                {
                                    ...
                                    "evidence": {
                                        ...
                                        "ready": False,
                                        "budget_source": "",
                                        "missing_sections": ["budget_source", "bounded_budget_limit"],
                                    },
                                },
                                {
                                    "requirement": "child_result_merge_semantics_defined",
                                    "status": "blocked",
                                    "blocker": "child_result_merge_semantics_defined",
                                    "evidence": {
                                        ...
                                        "merge_source": "",
                                        "merge_strategy": "",
                                        "missing_sections": ["merge_source", "merge_strategy", "intent_policy"],
                                    },
                                },
                                {
                                    "requirement": "explicit_executor_binding_opt_in",
                                    "status": "blocked",
                                    "blocker": "explicit_executor_binding_opt_in",
                                    "evidence": {
                            ...
                            "child_executor_context_budget_policy": {
                                "contract_version": "phase-ii-child-executor-context-budget-policy-v1",
                                "overall_status": "blocked",
                                "ready": False,
                                "budget_source": "",
                            ...
                            "child_result_merge_handoff_contract": {
                                "contract_version": "phase-ii-child-result-merge-handoff-v1",
                                "overall_status": "blocked",
                                "ready": False,
                                "merge_source": "",
