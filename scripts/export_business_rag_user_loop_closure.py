...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export the local MyPrivateAgent business RAG user-loop closure report.",
    )
    ...
    print(f"Business RAG user-loop closure JSON ready: {report.json_path}")
    print(f"Business RAG user-loop closure Markdown ready: {report.markdown_path}")
