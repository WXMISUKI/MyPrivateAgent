...
### Requirement: AgentHarnessFacade.execute() MUST accept an optional model_name string and auto-build a model_step callable from the provider registry when no explicit model_step is supplied
