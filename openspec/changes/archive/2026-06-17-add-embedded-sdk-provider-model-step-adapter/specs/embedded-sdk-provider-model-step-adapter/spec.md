...
### Requirement: build_provider_model_step() MUST return a valid ModelStepCallable that resolves a model from the provider registry and invokes it
...
### Requirement: The adapter MUST construct messages from the run context without requiring external message history
...
### Requirement: The adapter MUST be opt-in and MUST NOT change default behavior
...
### Requirement: The adapter MUST NOT expose unsafe provider objects in the result
