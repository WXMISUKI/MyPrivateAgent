...
- [x] Add runtime worker ownership requirements for PostgreSQL production gate wiring decision evidence.
- [x] Add production gate quality coverage requirements for the wiring decision.

## 2. Implementation

- [x] Add `build_worker_ownership_postgres_vendor_lock_production_gate_wiring_decision_contract(...)`.
- [x] Build default blocked and explicitly approved decision paths.
