...
- **AND** the check MUST preserve compact retry fields including contract version, attempt number, max attempts, retry status, terminal flag, recovery reason, and idempotency key presence
