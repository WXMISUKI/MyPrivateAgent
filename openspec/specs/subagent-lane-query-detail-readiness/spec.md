# subagent-lane-query-detail-readiness Specification

## Purpose
Define readiness signaling for the subagent lane query detail contract before detail payloads are consumed.
## Requirements
