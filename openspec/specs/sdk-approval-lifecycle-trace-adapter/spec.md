# sdk-approval-lifecycle-trace-adapter Specification

## Purpose

This specification defines the opt-in adapter that mirrors selected Embedded SDK approval lifecycle events into platform runtime trace as compact governance evidence.
