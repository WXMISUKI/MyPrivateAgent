# domain-agent-manifest-capability-linkage-readiness Specification

## Purpose
Define read-only linkage readiness for Tool, Skill, and MCP references declared in domain agent manifests.
