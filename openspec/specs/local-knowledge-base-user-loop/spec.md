# local-knowledge-base-user-loop Specification

## Purpose
TBD - created by archiving change add-myprivateagent-local-knowledge-base-user-loop. Update Purpose after archive.
## Requirements
