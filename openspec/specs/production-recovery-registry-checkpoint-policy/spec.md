# production-recovery-registry-checkpoint-policy Specification

## Purpose

Define machine-readable production policy evidence for registry binding resolution and checkpoint/resume cursor gating before durable cross-process recovery can become default behavior.
