# langgraph-smoke-projection-source Specification

## Purpose

Define the read-only projection source that converts LangGraph controlled pilot smoke evidence into compact runtime-plane governance projection evidence.
