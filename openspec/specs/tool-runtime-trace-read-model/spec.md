# tool-runtime-trace-read-model Specification

## Purpose
Define the ToolRuntime trace read model used to expose compact tool execution evidence to runtime and governance consumers.
## Requirements
