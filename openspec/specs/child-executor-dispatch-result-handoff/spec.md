# child-executor-dispatch-result-handoff Specification

## Purpose

Define the compact post-dispatch result handoff contract used after an opt-in child executor dispatcher invocation returns backend evidence.
