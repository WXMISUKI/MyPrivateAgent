# langgraph-controlled-pilot-readiness Specification

## Purpose

Define the side-effect-free readiness gate for deciding whether the LangGraph draft adapter can enter an explicit controlled pilot smoke.
