# continuation-descriptor-lifecycle-governance Specification

## Purpose

Define safe lifecycle classification for persisted continuation descriptors before they can participate in production cross-process recovery decisions.
