# child-intent-taxonomy-sections Specification

## Purpose
Define the child intent taxonomy and section vocabulary used to classify child executor outputs before parent merge.
## Requirements
