# external-rag-graphrag-provider-plan Specification

## Purpose

Define the planning contract for an independent RAG / GraphRAG provider that remains outside the MyPrivateAgent core backend while supporting provider-neutral knowledge capability integration.
