...
Define the side-effect-free handoff gate between child executor dispatch retry audit evidence and any explicit retry scheduler boundary.
...
- **WHEN** runtime smoke validates retryable-without-scheduler, missing-idempotency, missing-audit, terminal, and explicitly bound handoff paths
