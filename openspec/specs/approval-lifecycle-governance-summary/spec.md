...
Ensure Governance Timeline compact runtime contract warning summaries expose approval lifecycle recovery coverage without requiring operators to expand the full payload.
