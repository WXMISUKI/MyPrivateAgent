...
Define the read-only dry-run gate that explains whether child executor dispatch retry scheduler binding evidence is sufficient for a future execution authorization review without scheduling retries or enabling workers.
