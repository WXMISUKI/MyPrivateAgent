# tool-runtime-policy-coordination Specification

## Purpose
Define ToolRuntime policy coordination statuses and how execution responds to allowed, approval-required, and denied decisions.
## Requirements
