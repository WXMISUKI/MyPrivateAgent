# agent-harness-facade-v1 Specification

## Purpose
Define the Agent Harness facade contract that exposes stable agent runtime entrypoints without leaking implementation-specific orchestration details.
## Requirements
