# agent-memoryops-lifecycle-contract Specification

## Purpose
Define the minimal read-only MemoryOps lifecycle registry for existing runtime instruction memory, durable conversation summaries, and retrieved knowledge posture.
