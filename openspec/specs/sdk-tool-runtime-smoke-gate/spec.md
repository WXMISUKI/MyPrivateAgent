# sdk-tool-runtime-smoke-gate Specification

## Purpose
Ensure SDK direct ToolRuntime execution paths are covered by runtime contract smoke and quality gate evidence.
## Requirements
