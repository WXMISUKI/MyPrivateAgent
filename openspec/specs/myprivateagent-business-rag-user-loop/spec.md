...
Define the local caller-side closure that decides whether the current MyPrivateAgent business RAG user loop can proceed against an approved local corpus and explicit grounded-answer API.
