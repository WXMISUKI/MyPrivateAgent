# runtime-plane-approval-agent-adapter Specification

## Purpose
TBD - created by archiving change add-runtime-plane-approval-agent-adapter. Update Purpose after archive.
## Requirements
