...
Ensure Governance Timeline compact runtime contract warning summaries expose approved tool execution coverage without requiring operators to expand the full payload.
