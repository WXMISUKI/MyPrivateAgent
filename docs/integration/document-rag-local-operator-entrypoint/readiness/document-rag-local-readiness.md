...
- Generated At: `2026-06-07T12:49:25.447991+00:00`
...
|---|---|---|---|---|
| `ocr_provider` | `ready` | `ocr_profile_ready` | `http://127.0.0.1:8080/health` | `{"large_pdf_timeout_recommendation_seconds": 120.0, "ocr_profile": "gpu", "ocr_timeout_seconds": 180.0, "raw": {"errorCode": 0, "errorMsg": "Healthy", "logId": "c131bd53-5df1-4609-9d15-594bfbbf177d"}, "status": "ready"}` |
